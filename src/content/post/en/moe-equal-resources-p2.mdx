...
image: "/assets/papers/moe-equal-resources-p2/blog_assets/arch_fig_shape_ratios_right.png"
tags:
  - "MoE"
  - "Pretrain"
  - "LLM"
...
<div style={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: "12px", margin: "0 0 22px" }}>
  <a className="download-card" href="/assets/papers/moe-equal-resources-p2/camera_ready.pdf" style={{ display: "block", border: "1px solid #d8e2f0", borderRadius: "8px", padding: "12px 14px", background: "#f8fbff", textDecoration: "none", color: "inherit" }}>
    <div style={{ fontWeight: "700" }}>ICLR 2026 Oral</div>
    <div>Camera Ready PDF</div>
  </a>
  <a className="download-card" href="/assets/papers/moe-equal-resources-p2/Final%20vision/v20260425_183821/slides.pdf" style={{ display: "block", border: "1px solid #d8e2f0", borderRadius: "8px", padding: "12px 14px", background: "#f8fbff", textDecoration: "none", color: "inherit" }}>
    <div style={{ fontWeight: "700" }}>Slides</div>
    <div>Talk slides PDF</div>
  </a>
  <a className="download-card" href="/assets/papers/moe-equal-resources-p2/Final%20vision/v20260422_225200/poster.pdf" style={{ display: "block", border: "1px solid #d8e2f0", borderRadius: "8px", padding: "12px 14px", background: "#f8fbff", textDecoration: "none", color: "inherit" }}>
